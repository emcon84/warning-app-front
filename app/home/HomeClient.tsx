          ...
          <div className="relative overflow-hidden rounded-2xl h-44 md:h-52">
            ...
            <div className="relative z-10 h-full flex flex-col justify-center px-5 gap-1.5 w-[90%] md:max-w-[60%]">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-semibold uppercase tracking-wider text-white/60">PEDIDOS POR WHATSAPP</span>
              </div>
              <h3 className="text-white font-bold text-xl leading-tight">Pedí en tus locales favoritos</h3>
              <p className="text-white/70 text-xs leading-relaxed">Armá tu pedido y mandalo directo al WhatsApp del comercio. Simple y sin apps extra.</p>
              <Link href="/comercios" className="inline-flex items-center gap-1.5 font-bold text-xs px-4 py-2.5 rounded-full w-fit mt-0.5 transition-opacity hover:opacity-90 text-white" style={{ background: "#25D366" }}>
