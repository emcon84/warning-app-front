    ...
    return (
      <div className={`min-h-screen ${bg} pb-24 md:pb-0`}>
        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] pt-16 px-6 text-center gap-6">
          ...
          <div>
            <h1 className={`text-2xl font-bold mb-2 ${isDark ? "text-white" : "text-gray-900"}`}>Perfil publicado</h1>
            <p className={`text-sm ${textSec}`}>Tu perfil ya es visible para empleadores en Reconquista.</p>
          </div>
              ...
              <div key={s.num} className="flex items-center flex-1">
                <div className="flex flex-col items-center gap-1">
                  <div className={`w-9 h-9 rounded-full flex items-center justify-center border-2 transition-all ${
                    done ? "bg-blue-600 border-blue-600" : active ? isDark ? "border-blue-500 bg-blue-900/30" : "border-blue-500 bg-blue-50" : isDark ? "border-gray-700 bg-gray-900" : "border-gray-300 bg-white"
                  }`}>
                    {done
                      ? <CheckCircle className="w-4 h-4 text-white" />
                      : <Icon className={`w-4 h-4 ${active ? isDark ? "text-blue-400" : "text-blue-600" : isDark ? "text-gray-600" : "text-gray-400"}`} />
                    }
                  </div>
                  <span className={`text-[10px] font-medium hidden sm:block ${active ? isDark ? "text-blue-400" : "text-blue-600" : isDark ? "text-gray-600" : "text-gray-400"}`}>
                    {s.label}
                  </span>
                </div>
                {idx < steps.length - 1 && (
                  <div className={`flex-1 h-0.5 mx-2 ${step > s.num ? "bg-blue-600" : isDark ? "bg-gray-800" : "bg-gray-200"}`} />
                )}
              </div>
            );
          })}
        ...
        <div className={`rounded-2xl border p-6 ${cardBg}`}>
          ...
          {step === 1 && (
            <div className="flex flex-col gap-5">
              <div>
                <h2 className={`text-lg font-bold mb-1 ${isDark ? "text-white" : "text-gray-900"}`}>Datos personales</h2>
          ...
          {step === 2 && (
            <div className="flex flex-col gap-5">
              <div>
                <h2 className={`text-lg font-bold mb-1 ${isDark ? "text-white" : "text-gray-900"}`}>Tus habilidades</h2>
          ...
          {step === 3 && (
            <div className="flex flex-col gap-5">
              <div>
                <h2 className={`text-lg font-bold mb-1 ${isDark ? "text-white" : "text-gray-900"}`}>Contacto y disponibilidad</h2>
