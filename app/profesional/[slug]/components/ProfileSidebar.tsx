...
export function ProfileSidebar({
  ...
  isDark, cardBg, tagBg, textPrimary, textSec, textMuted, secBtn,
    ...
    <aside className="w-full md:w-80 flex-shrink-0">
      <div className="md:sticky md:top-24 space-y-5">
        ...
        <div className={`rounded-2xl overflow-hidden border-2 ${cardBg} shadow-lg`}>
          <div className="aspect-square relative">
            {pro.foto ? (
              ...
              <div className={`w-full h-full flex items-center justify-center text-6xl font-bold ${textMuted}`}>
        ...
        <div>
          ...
          <p className={`text-sm mt-2 ${textMuted}`}>{pro.barrio}, Reconquista</p>
        ...
        <div className="space-y-2 pt-2">
          {pro.whatsapp ? (
            <button
              onClick={onWhatsapp}
              className="w-full py-3 rounded-xl font-semibold text-sm transition-colors bg-green-600 hover:bg-green-500 text-white flex items-center justify-center gap-2"
            >
          ...
          <div className="flex gap-2">
            <button
              onClick={onShare}
              className={`flex-1 flex items-center justify-center py-2.5 rounded-xl border transition-colors text-sm font-medium gap-1.5 ${secBtn}`}
            >
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center py-2.5 rounded-xl text-sm transition-colors border ${
            ...
            <button
              onClick={onCopy}
              className={`flex-1 flex items-center justify-center py-2.5 rounded-xl text-sm transition-colors border ${secBtn}`}
            >
              {copied ? "✓" : (
