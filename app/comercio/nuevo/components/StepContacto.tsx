...
export function StepContacto({ form, setForm, whatsappRaw, onWhatsappChange, showPin, setShowPin, inputCls, isDark, textSec, textMut }: Props) {
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className={`rounded-2xl border p-4 ${isDark ? "bg-blue-950/30 border-blue-800/40" : "bg-blue-50 border-blue-200"}`}>
        ...
        <p className={`text-xs mb-3 ${isDark ? "text-blue-400/70" : "text-blue-600/70"}`}>
          Con tu WhatsApp + este PIN vas a poder gestionar tu comercio desde cualquier dispositivo.
        </p>
