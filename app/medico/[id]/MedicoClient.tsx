  ...
  return (
    <div className={`min-h-screen ${bg} ${textPrimary}`}>
      ...
      <div className="max-w-xl md:max-w-4xl mx-auto px-4 md:px-8 pt-20 pb-32">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className={`text-xs mt-0.5 ${isDark ? "text-amber-400/80" : "text-amber-700"}`}>
                Si encontras datos incorrectos — direccion, obra social u otro dato — podés corregirlos vos mismo.
              </p>
              <button
        ...
        {/* Éxito al guardar */}
        {saveState === "success" && (
          <div className={`rounded-2xl border p-3 mb-4 flex items-center gap-2 ${
        ...
        <div className={`rounded-2xl border mb-4 overflow-hidden ${cardBg}`}>
          <button
